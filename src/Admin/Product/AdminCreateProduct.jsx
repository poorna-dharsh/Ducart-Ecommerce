  ...
  function postData(e) {
    ...
    if (error) setShow(true);
      ...
      const maincategory =
        data.maincategory !== ""
          ? data.maincategory
          : MaincategoryStateData?.[0]?.name || ""; // Use optional chaining

      const subcategory =
        data.subcategory !== ""
          ? data.subcategory
          : SubcategoryStateData?.[0]?.name || ""; // Use optional chaining

      const brand =
        data.brand !== "" ? data.brand : BrandStateData?.[0]?.name || ""; // Use optional chaining
      ...
      formData.append(
        ...
        new Blob(
          [
            JSON.stringify({
              name: data.name,
              maincategory: maincategory, // Now safe
              subcategory: subcategory, // Now safe
              brand: brand, // Now safe
              color: data.color,
              size: data.size,
              basePrice: bp,
              discount: discount,
      ...
      // Handle images
      if (data.pic instanceof FileList) {
